package com.quantumstudios.gtquantumcore.common.metatileentities.single.steam;
...
public class SteamAmmoPress extends SteamMetaTileEntity {

    public SteamAmmoPress(ResourceLocation metaTileEntityId, boolean isHighPressure) {
        super(metaTileEntityId, RecipeMapsHandler.AMMO_PRESS, Textures.FURNACE_OVERLAY, isHighPressure);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new SteamAmmoPress(metaTileEntityId, isHighPressure);
    }
