...
{
	public static final RecipeMap<SimpleRecipeBuilder> ELECTRICAL_SPRENGEL_PUMP_MAP = new RecipeMap<>("electrical_sprengel_pump", 3, 1, 1, 0,
    ...
    public static final RecipeMap<SimpleRecipeBuilder> STEAM_ALLOY_BLAST_FURNACE = new RecipeMap<>("steam_alloy_furnace", 4, 1, 4, 1, new SimpleRecipeBuilder().duration(10), false);
}
